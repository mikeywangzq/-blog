...
- 📖 [完整开发指南](docs/开发指南.md) - 系统架构、API接口、功能实现详解
  - 系统架构说明
  - 技术栈详解
  - 已实现功能详细文档
  - API接口完整文档
...
欢迎贡献代码！在开始之前，请先阅读 [开发指南](docs/开发指南.md) 了解项目架构和技术细节。
...
- 📖 [完整开发指南](docs/开发指南.md) - 查看系统架构、API文档等
- 🔧 [API文档](http://localhost:8080/api/swagger-ui.html) - Swagger在线文档（启动后端后访问）
